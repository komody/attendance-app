...
<head>
    ...
    <title>{{ $user->name }}さんの勤怠 - {{ config('app.name') }}</title>
...
<body>
    ...
    <main class="attendance-list">
        <div class="attendance-list-container">
            ...
            <div class="attendance-list-csv-wrap">
                <a href="{{ route('admin.attendance.staff.csv.date', ['id' => $user->id, 'year' => $currentYear, 'month' => $currentMonth]) }}" class="attendance-list-csv-btn">CSV出力</a>
            </div>
        </div>
    </main>
</body>
