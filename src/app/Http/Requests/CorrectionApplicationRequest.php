...
class CorrectionApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'new_breaks.*.corrected_break_start' => 'required_with:new_breaks.*.corrected_break_end|nullable|date_format:H:i',
            'new_breaks.*.corrected_break_end' => 'required_with:new_breaks.*.corrected_break_start|nullable|date_format:H:i',
        ];
    }
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            // Rule 2 & 3: 休憩時間の検証
            foreach (array_merge($breaks ?? [], $newBreaks ?? []) as $index => $break) {
